...
const translations = {
  fr: {
    ...
    'ops.text': 'Nous formons des équipes de cinq accompagnateurs pour quatre participants, avec des rotations toutes les trois heures. Logé et nourri dans des bâtiments modernes, en pleine nature, avec des accompagnateurs qui sont là pour les bonnes raisons.',
  ...
  en: {
    ...
    'ops.text': 'We form teams of five counselors for four participants, with rotations every three hours. Lodged and fed in modern buildings, in nature, with counselors who are there for the right reasons.',
